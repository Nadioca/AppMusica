...
public class CategoriasActualizacionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextCategoriasNombre.setText(this.getIntent().getExtras().getString("Nombre"));
    ...
    void attemptGuardar(){
        ...
        Categorias ciclo = new Categorias(cicloId, nombre);
        CategoriasProveedor.update(getContentResolver(), ciclo, this);
        finish();
    }
}
