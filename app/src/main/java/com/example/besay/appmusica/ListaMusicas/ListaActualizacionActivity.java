...
public class ListaActualizacionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int idmusica = this.getIntent().getExtras().getInt("Id_Musica");
        int suscriptores = this.getIntent().getExtras().getInt("Suscriptores");

        editTextListaNombre.setText(String.valueOf(idmusica));
        editTextListaSuscriptores.setText(String.valueOf(suscriptores));
    ...
    void attemptGuardar(){
        ...
        Lista_Musica ciclo = new Lista_Musica(cicloId, categorias, susc);

        ListaMusicaProveedor.update(getContentResolver(), ciclo, this);
        finish();
    }
}
